...
![网卡接收数据的过程](/images/linux/epoll/epoll-2.jpg)
...
![socket的等待队列](/images/linux/epoll/epoll-7.jpg)
...
![将进程A从所有等待队列中移除，再加入到工作队列里面](/images/linux/epoll/epoll-12.jpg)
...
![内核创建eventpoll对象 ](/images/linux/epoll/epoll-15.jpg)
